...
path_and_rename_image_share = PathAndRename("image_share")
...
class Image(models.Model):
    ...
    user = models.ForeignKey("main.User", verbose_name=_("User"), on_delete=models.SET_NULL, blank=True, null=True,
                             related_name='user')
    lat = models.FloatField(validators=[MinValueValidator(-90), MaxValueValidator(90)], max_length=100, null=True,
                            blank=True)
    lng = models.FloatField(validators=[MinValueValidator(-180), MaxValueValidator(180)], max_length=100, null=True,
                            blank=True)
...
class ImageFile(models.Model):
    ...
    score = models.FloatField(_("Score"), validators=[MinValueValidator(-1), MaxValueValidator(1)], max_length=10,
...
class ObjectType(models.Model):
    ...
    created_by = models.ForeignKey("main.User", related_name='object_types', verbose_name=_("Created By"),
                                   on_delete=models.SET_NULL, blank=True, null=True)
    project = models.ForeignKey(Projects, related_name='object_types', verbose_name=_("Project"),
                                on_delete=models.CASCADE, blank=True, null=True)
    image = models.ImageField(_("Image"), upload_to=path_and_rename_object_types, default='object_types/default.jpg',
                              blank=True)
...
class Classifier(models.Model):
    ...
    project = models.ForeignKey(Projects, related_name='classifiers', verbose_name=_("Project"),
                                on_delete=models.CASCADE, blank=True, null=True)
    object_type = models.ForeignKey(ObjectType, related_name='classifiers', verbose_name=_("Object Type"),
                                    on_delete=models.SET_NULL, blank=True, null=True)
    order = models.IntegerField(_("Order"), default=0, blank=False, null=False)
    offline_model = models.ForeignKey('OfflineModel', on_delete=models.SET_NULL, verbose_name=_("Offline Model"),
                                      related_name='classifiers', blank=True, null=True)
    ...
    created_by = models.ForeignKey("main.User", related_name='classifiers', verbose_name=_("Created By"),
                                   on_delete=models.SET_NULL, blank=True, null=True)
    created_at = models.DateTimeField(_("created_at"), auto_now_add=True)
    updated_at = models.DateTimeField(_("updated_at"), auto_now=True)
...
class OfflineModel(models.Model):
    ...
    created_by = models.ForeignKey("main.User", related_name='offline_models', verbose_name=_("Created By"),
                                   on_delete=models.SET_NULL, blank=True, null=True)
...
class FileUpload(models.Model):
    ...
    created_by = models.ForeignKey("main.User", related_name='file_uploads', verbose_name=_("Created By"),
                                   on_delete=models.SET_NULL, blank=True, null=True)
    created_at = models.DateTimeField(_("created_at"), auto_now_add=True)
    updated_at = models.DateTimeField(_("updated_at"), auto_now=True)
...
class Contribution(models.Model):
    ...
    object_type = models.ForeignKey(ObjectType, related_name='contributions', verbose_name=_("Object Type"),
                                    on_delete=models.CASCADE)
    is_helpful = models.BooleanField(_("Is Helpful"), default=False)
    created_by = models.ForeignKey("main.User", related_name='contributions', verbose_name=_("Created By"),
                                   on_delete=models.SET_NULL, blank=True, null=True)
    created_at = models.DateTimeField(_("created_at"), auto_now_add=True)
    updated_at = models.DateTimeField(_("updated_at"), auto_now=True)
