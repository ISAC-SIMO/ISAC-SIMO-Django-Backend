...
from .decorator import can_translate, can_translate_language
...
class TranslatorBaseMixin(object):
    ...
    * a property for the 'po_filter' url argument
    ...
    def dispatch(self, *args, **kwargs):
        return super(TranslatorBaseMixin, self).dispatch(*args, **kwargs)
...
class TranslatorFileLevelMixin(TranslatorBaseMixin):
...
class TranslationFileListView(TranslatorBaseMixin, TemplateView):
    ...
    template_name = 'translator/file-list.html'
...
class TranslationFormView(TranslatorFileLevelMixin, TemplateView):
...
class TranslationFileDownload(TranslatorFileLevelMixin, View):
